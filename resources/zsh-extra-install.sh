...
## Install additional Raku packages
...
zef install https://github.com/ugexe/Perl6-Text--Table--Simple.git
...
zef install https://github.com/antononcube/Raku-ML-ROCFunctions.git
